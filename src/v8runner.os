...
Процедура ПолучитьОтчетОСравненииКонфигурацииСФайлом(
	...
	КонецЕсли;
	Если Объекты.Свойство("ИзмененныеОбъектыМетаданных")
		И Объекты.ИзмененныеОбъектыМетаданных Тогда
		ПараметрыЗапуска.Добавить("-IncludeChangedObjects");
	КонецЕсли;
	Если Объекты.Свойство("УдаленныеОбъектыМетаданных")
		И Объекты.УдаленныеОбъектыМетаданных Тогда
		ПараметрыЗапуска.Добавить("-IncludeDeletedObjects");
	КонецЕсли;
	Если Объекты.Свойство("ДобавленныеОбъектыМетаданных")
		И Объекты.ДобавленныеОбъектыМетаданных Тогда
